# Duhaa (ﺿﺤﻰ) — project context for Codex
...
**If you are a fresh Codex session: read `DUHAA_SPEC.md` first — it is the full, authoritative spec.** The `context/` folder holds the original locked decision docs from the design session.
